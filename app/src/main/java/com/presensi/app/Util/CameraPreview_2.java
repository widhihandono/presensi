...
public class CameraPreview_2 extends ViewGroup implements SurfaceHolder.Callback, FaceDetectionListener{
    /**
    ...
    CameraPreview_2(Context context) {
        super(context);
...
//        view.setFaces(Arrays.asList(faces));
    ...
    public CameraPreview_2(Context context, AttributeSet attr) {
        super(context, attr);
        mSurfaceView = new SurfaceView(context);
        addView(mSurfaceView);
